<template>
    <div>        
        <div class="mb-2 border-b-2 p-2" @click="changeCategory(1004)" ref="getData1004">全体</div>
        <div class="mb-2 p-2" @click="changeCategory(1141)" ref="getData1141">重要</div>
        <div class="form-floating">
            <select class="form-select" id="floatingSelect" aria-label="Floating label select example" @change="changeCategory(categoryNum)" v-model="categoryNum" @click="Emptyalert">
